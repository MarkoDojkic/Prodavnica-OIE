/*
 ...
 Source Server         : prodavnicaoie
 Source Server Type    : MySQL
 Source Server Version : 80018
 Source Host           : localhost:3306
 Source Schema         : prodavnicaoie

 Target Server Type    : MySQL
 Target Server Version : 80018
 File Encoding         : 65001

 Date: 20/05/2020 14:25:03
*/
...
-- ----------------------------
BEGIN;
INSERT INTO `customer` VALUES (1, '2020-05-18 16:34:22', '2020-05-20 14:21:54', '2_1', 'Марко Дојкић', '$2y$10$I1yUzAeOqwBFHh0sBWyFO.F3pmWxlVr8s9c2S4f.VA6HsQMwNE7OW', '+381641244875', 'marko.dojkic.18@singimail.rs', 478236, 1, 1);
...
-- ----------------------------
-- Table structure for customerPaymentData
-- ----------------------------
DROP TABLE IF EXISTS `customerPaymentData`;
CREATE TABLE `customerPaymentData` (
...
-- ----------------------------
-- Records of customerPaymentData
-- ----------------------------
BEGIN;
...
-- ----------------------------
BEGIN;
INSERT INTO `employee` VALUES (1, '2020-05-18 16:43:14', '2020-05-20 14:20:24', NULL, 'mdojkic@markodojkic.rs', 'Марко Дојкић', '$7yQMag3xAzFa8ogaCG4RlOJEXArXlxVHasB/AxLa7RNrtNNF0lGg2', 1, 5);
INSERT INTO `employee` VALUES (2, '2020-05-18 16:44:13', '2020-05-20 14:15:28', '1_2', 'mpekic@markodojkic.rs', 'Milan Pekić', '$2y$10$763GUYuueZXM63YD5Xa/RuoSV3hsb5KtJPiLphbogmmwEcTcWsPT.', 0, 3);
COMMIT;
...
INSERT INTO `order` VALUES (8, '2020-05-20 14:15:00', '2020-05-20 14:15:37', '1_2', 2, 4, 'delivered', 0);
COMMIT;
...
INSERT INTO `order_product` VALUES (32, '2020-05-20 14:15:00', NULL, '4', 8, 49, 5);
COMMIT;
...
INSERT INTO `product` VALUES (49, '2020-05-19 14:13:04', '2020-05-20 14:15:00', '2_4', 'Литијумски PowerBrick 12V 7.5Ah', 'battery', 145, 'product_49.png', 15320.00);
...
CREATE TABLE `session` (
  ...
  `sessionName` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `status` enum('active','saved') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'active',
  `sessionType` enum('customer','employee') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'customer',
